...
public class Program : Form
{
    ...
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine("- For bug reporting, updates, and useful info,\n- go to https://github.com/VAST-THE-DOGE/Tiles");
        ...
        Console.WriteLine(RichPresenceHelper.SetupRichPresence() 
        ? "- Discord Rich Presence Setup Successful" : "- Discord Rich Presence Setup Error");
        ...
        try
        {
            ...
            {
                tileIcons[i] = HelperStuff.ResizeImage(HelperStuff.LoadImage("Tile"+i),16*ImageQuality,16*ImageQuality);
            }

            Console.WriteLine("- Loading Menu Images...");
            for (int i = 0; i < menuIcons.Length; i++)
            {
                menuIcons[i] = HelperStuff.ResizeImage(HelperStuff.LoadImage("Menu"+i),16*ImageQuality,16*ImageQuality);
            }
        }
        catch
        {
