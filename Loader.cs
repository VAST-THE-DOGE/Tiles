...
namespace Tiles
{
	public partial class Loader : Form
	{
		...
		{
			TableLayoutPanelCellPosition pos = MainTable.GetCellPosition(MiddlePanel);

			// Get the widths of all columns and heights of all rows
			int[] columnWidths = MainTable.GetColumnWidths();
			int[] rowHeights = MainTable.GetRowHeights();
